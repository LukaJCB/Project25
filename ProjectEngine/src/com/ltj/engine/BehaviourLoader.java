...
public class BehaviourLoader {
	...
	public static Behaviour<? extends SimpleSpriteAndroid> loadBehaviour(String fileName, String path) throws ClassNotFoundException, IOException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
		...
		if (compiled){
				...
				//return behaviour
				return (Behaviour<? extends SimpleSpriteAndroid>) cons.newInstance((Object[])null);
		}
		return null;
	}
}
